...
namespace Ambulance_mng_db {
    ...
    public partial class StaffDataSet1 : global::System.Data.DataSet {
        ...
        public partial class StaffDataTable : global::System.Data.TypedTableBase<StaffRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StaffRow AddStaffRow(int StaffID, string Name, int ContactNo, string Profession, int AmbID, string Shift) {
        ...
        public partial class StaffRow : global::System.Data.DataRow {
            ...
            public int ContactNo {
                get {
                    return ((int)(this[this.tableStaff.ContactNoColumn]));
                }
                set {
            ...
            public int AmbID {
                get {
                    return ((int)(this[this.tableStaff.AmbIDColumn]));
                }
                set {
                    this[this.tableStaff.AmbIDColumn] = value;
                }
            }
...
namespace Ambulance_mng_db.StaffDataSet1TableAdapters {
    ...
    public partial class StaffTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Staff] WHERE (([StaffID] = @Original_StaffID) AND ([ContactNo]" +
                " = @Original_ContactNo) AND ([AmbID] = @Original_AmbID) AND ([Shift] = @Original" +
                "_Shift))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Staff] ([StaffID], [Name], [ContactNo], [Profession], [AmbID]," +
                " [Shift]) VALUES (@StaffID, @Name, @ContactNo, @Profession, @AmbID, @Shift);\r\nSE" +
                "LECT StaffID, Name, ContactNo, Profession, AmbID, Shift FROM Staff WHERE (StaffI" +
                "D = @StaffID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Staff] SET [StaffID] = @StaffID, [Name] = @Name, [ContactNo] = @ContactNo, [Profession] = @Profession, [AmbID] = @AmbID, [Shift] = @Shift WHERE (([StaffID] = @Original_StaffID) AND ([ContactNo] = @Original_ContactNo) AND ([AmbID] = @Original_AmbID) AND ([Shift] = @Original_Shift));
SELECT StaffID, Name, ContactNo, Profession, AmbID, Shift FROM Staff WHERE (StaffID = @StaffID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Ambulance_mng_db.Properties.Settings.Default.StaffConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StaffID, Name, ContactNo, Profession, AmbID, Shift FROM dbo.Staff";
        ...
        public virtual int Fill(StaffDataSet1.StaffDataTable dataTable) {
        ...
        public virtual StaffDataSet1.StaffDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StaffDataSet1.StaffDataTable dataTable = new StaffDataSet1.StaffDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StaffDataSet1.StaffDataTable dataTable) {
        ...
        public virtual int Delete(int Original_StaffID, int Original_ContactNo, int Original_AmbID, string Original_Shift) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_StaffID));
            this.Adapter.DeleteCommand.Parameters[1].Value = ((int)(Original_ContactNo));
            this.Adapter.DeleteCommand.Parameters[2].Value = ((int)(Original_AmbID));
        ...
        public virtual int Insert(int StaffID, string Name, int ContactNo, string Profession, int AmbID, string Shift) {
            ...
            this.Adapter.InsertCommand.Parameters[4].Value = ((int)(AmbID));
            if ((Shift == null)) {
        ...
        public virtual int Update(int StaffID, string Name, int ContactNo, string Profession, int AmbID, string Shift, int Original_StaffID, int Original_ContactNo, int Original_AmbID, string Original_Shift) {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(AmbID));
            if ((Shift == null)) {
                throw new global::System.ArgumentNullException("Shift");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Original_ContactNo));
            this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Original_AmbID));
            if ((Original_Shift == null)) {
                throw new global::System.ArgumentNullException("Original_Shift");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, int ContactNo, string Profession, int AmbID, string Shift, int Original_StaffID, int Original_ContactNo, int Original_AmbID, string Original_Shift) {
            return this.Update(Original_StaffID, Name, ContactNo, Profession, AmbID, Shift, Original_StaffID, Original_ContactNo, Original_AmbID, Original_Shift);
        }
    }
